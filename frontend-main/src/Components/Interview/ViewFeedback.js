        ...
        <form>
            ...
            <div className='col-md-5'>
              <div className='form-group '>
                <input
                  ...
                  className='form-control responsive ms-4 width:25rem font-size:0.9rem'
            ...
            <div className='col-md-5'>
              <div className='form-group'>
                <input
                  ...
                  class='form-control responsive ms-4 width:25rem font-size:0.9rem'
          ...
          <div className='row'>
            ...
            <div className='col-md-5'>
              <div className='form-group'>
                <textarea
                  className='form-control ms-4 responsive'
                  value={Remark}
