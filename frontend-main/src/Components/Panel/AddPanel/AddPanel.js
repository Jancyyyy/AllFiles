...
function AddPanelIG() {
  ...
  //const [dynamic_roles_dropdown,setDynamic_roles_dropdown]=useState([]);
  ...
  async function fetchUser() {
    try {
      ...
      panel_info.current.email = data[0].email;
      panel_info.current.associate_name = data[0].name;
      
      if (UserData.status == 200) {
        setAssociate_id_valid("")
  ...
  async function getDropdown() {
    try {
      ...
      setIs_role_selected(new Array(data.roles.length).fill(false))
        ...
        <form onSubmit={submitData}>
          <div className='container-wrap'>
            <div className='row mb-3'>
              ...
              <div className='col-md-5'>
                <div className='form-group'>
                  <input
                    type='text'
                    className={`form-control responsive ${associate_id_valid}`}
            ...
            <div className='row mb-3'>
              ...
              <div className='col-md-5 email__panel'>
                <div className='form-group'>
                  <input
                    type='email'
                    className={`form-control responsive  `}
              ...
              <div className='col-md-5'>
                <div className='form-group '>
                  <input
                    type='text'
                    className={`form-control responsive ${contact_valid}`}
            ...
            <div className='row mb-3'>
              ...
              <div className='col-md-5 grade__panel'>
                <div className='form-group'>
                  <select
                    id='grade'
