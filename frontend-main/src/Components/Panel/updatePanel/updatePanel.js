...
function UpdatePanel() {
    ...
    const {id, name, availdate, grade,start_time,end_time,availability_status} = useParams();
    ...
    useEffect(()=>{
        ...
        fromTime.current.value=start_time;
        toTime.current.value=end_time;
        status.current.value=availability_status;
        ...
        <div className="container-wrap px-3 mt-3">
            <>
                <div className='container-wrap px-3'>
                    <h2 className="col-0 mb-5"> Update Panel Availability</h2>
                    ...
                    <form>
                        ...
                        <div className="row mb-3">
                            <div>
                                ...
                                <button type="button" className="btn btn-primary  me-3 ms-4" onClick={()=>{navigate('/panelavailbility')}} data-testid="cancel" >
                                    Cancel
                                </button>
                            </div>
                        </div>
