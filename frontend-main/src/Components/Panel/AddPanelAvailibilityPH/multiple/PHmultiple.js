...
function PANELmultiple() {
  ...
  // const AssociateList = ['Onkar', 'Upendra', 'Vikrant', 'Umesh', 'Jakku', 'Lithik'];
  ...
  const getdata = async (associate_name) => {
    ...
    console.log(associate_name)
    console.log("getdata")
    const res = await fetch("http://localhost:8000/panel_availability", {
      method: "POST",
      headers: {
        //'Accept': 'application/json',
        "Content-Type": "application/json",
  ...
  const postdata = async (e) => {
    ...
    if (!showTimeErr && data.end_time && data.start_time && data.fromdate && data.todate && ID) {
      ...
      try {
       ...
       toast.error("Time slot already exists", {autoClose: 1000});
  ...
  useEffect(() => {
    fetch(hostURL + "/panel_availability/panelNames", {
      ...
      for (let i of result.data) {
        let temp = `${i.name}-${i.user_id}`
        AssociateList.push(temp);
      }
      setNameList(AssociateList);
  ...
  return (
    <div className="p-2">
      <NavBar />
      <div className="container-wrap px-0">
        <>
          <div className='container-wrap'>
            <h2 className="col-0 mb-5"> Add Panel Availability - Multiple(PH)</h2>
            ...
            <form>
                  ...
                  <div className="form-group position-relative">
                    <div className="form-group">
                      <Autocomplete
                        ...
                        onChange={(e) => { fillValues(e.target); }}
              ...
              <div className="row mb-5">
                ...
                <p style={{ color: "red", paddingLeft: "800px" }}>{showTimeErr}</p>
              </div>
              ...
              <div className="row addList__button">
                <div>
                  ...
                  <button type="cancel" onClick={() => { navigate('/panelavailbility') }} className="btn btn-primary " data-testid="cancel" value="" >
                    Cancel
                  </button>
                </div>
              </div>
