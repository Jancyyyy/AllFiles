...
function PANELmultiple() {
  ...
  useEffect(() => {
    getdata(userData.name + "-" + userData.user_id);
  }, []);
  ...
  const postdata = async (e) => {
    ...
    if (!showTimeErr && data.end_time && data.start_time && data.fromdate && data.todate && ID) {
      ...
      // window.alert("please fill the valid data");
          ...
          <div className='container-wrap'>
            ...
            <form>
              <div className="row mb-3">
                ...
                <div className="col-md-5">
                  <div className="form-group position-relative">
                    ...
                    <select name="associatename" value={userData.name + "-" + userData.user_id} disabled onChange={(e) => { fillValues(e.target); }} className="form-control responsive">
              ...
              <div className="row mb-3">
                ...
                <div className="col-md-5">
                  <div className="form-group">
                    <input name="fromdate" onChange={handleInputs} value={data.fromdate} className="form-control responsive" type="date" min={new Date().toISOString().split('T')[0]} placeholder=" Select Date" required />
                  </div>
                </div>
                ...
                <div className="col-md-5">
                  <div className="form-group">
                    <input name="todate" onChange={handleInputs} value={data.todate} className="form-control responsive" type="date" min={data.fromdate} placeholder="Select Date" required />
                  </div>
                </div>
              </div>
              <div className="row mb-3">
