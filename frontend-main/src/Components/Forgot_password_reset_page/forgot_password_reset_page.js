...
function ForgotPasswordReset() {
  ...
  function reset(e) {
    ...
    console.log(
      "Hashed : " + hashSync(password.current.value),
    );
    fetch(
      hostURL + "/forgot_password/forgotpasswordreset",
      {
        method: "PUT",
        headers: {
        ...
        <form className='password-reset-page-form'>
          ...
          <div
            ...
            <button
              onClick={reset}
              disabled={btnDisable}
              className='btn btn-primary col-5 mt-4'>
              Set Password
            </button>
