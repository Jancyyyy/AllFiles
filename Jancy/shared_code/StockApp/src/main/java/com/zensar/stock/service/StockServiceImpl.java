...
public class StockServiceImpl implements StockService {
	...
	public List<Stock> findByMarket(String marketName) {
		List<StockEntity> stockEntityList = stockRepository.findByMarket(marketName);
		return getStockDtoList(stockEntityList);
	}
	...
	public List<Stock> findByNameAndMarket(String name, String marketName) {
		List<StockEntity> stockEntityList = stockRepository.findByNameAndMarket(name, marketName);
		return getStockDtoList(stockEntityList);
	}
