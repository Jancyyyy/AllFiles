...
function panelList(req,res,next){
    ...
    // console.log(Object.keys(dbConstraints1))
    // console.log(333333333333)
    // const dbc = {...dbConstraints1, ...dbConstraints2};
    // for(let i of Object.keys(dbc)){
    //     let u = ((`{${i} : ${JSON.stringify(dbc[i])}}`));
    //     console.log(JSON.stringify(u));
    // }
    // console.log(Object.keys(dbConstraints1).map(item => {
    //     console.log(item)
    //     return {item: dbConstraints1.item}
    // }))
    Panel.aggregate([
        {
            $lookup:{
